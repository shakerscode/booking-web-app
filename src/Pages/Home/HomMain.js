...
const HomMain = () => {
    ...
    return (
        <div className='bg-sky-600 md:h-[400px] px-2'>
            ...
            <div className='text-white mt-4  md:px-12 px-5 md:pb-16 pb-8'>
            <h1 className='font-bold md:text-5xl text-3xl text-start md:py-4'>A lifetime of discounts? It's Genius.</h1>
